  ...
  $.ajax({
    ...
    success: function(resposta) {
      ...
      if(pagina <= totalPagina) {
        ...
        for(var j = 0; j < totalPagina; j++){
          $("#contador tr").remove();
          var linhaContador = "<li onclick='paginaUnica(1)' class='page-item'><a class='page-link' href='#'>2</a></li>"
          contadorHtml.innerHTML += linhaContador;
        }
